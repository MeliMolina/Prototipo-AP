...
public class ActivityCitasBuscar extends CommonCode {
    ...
    public void llenarTabla(ArrayList<Paciente> matriz_datos){
        ...
        for(int i=0; i<matriz_datos.size() ; i++){
            ...
            button_mostrar.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(ActivityCitasBuscar.this, ActivityPacientesVista.class);
            ...
            button_editar.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(ActivityCitasBuscar.this, ActivityPacientesEditar.class);
