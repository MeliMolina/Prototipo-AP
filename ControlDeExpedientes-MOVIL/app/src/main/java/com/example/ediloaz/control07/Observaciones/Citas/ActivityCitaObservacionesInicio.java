...
import com.example.ediloaz.control07.Observaciones.Pacientes.ActivityPacienteObservacionMostrar;
...
import com.example.ediloaz.control07.Observaciones.Pacientes.dbListadoPacienteObservaciones;
...
public class ActivityCitaObservacionesInicio extends CommonCode {
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        dbListadoCitaObservaciones db = new dbListadoCitaObservaciones(this,progressBar,paciente_id);
        db.execute("");
    }
    ...
    public void llenarTabla(ArrayList<Observacion> matriz_datos){
        ...
        for(int i=0; i<matriz_datos.size() ; i++){
            ...
            button_mostrar.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(ActivityCitaObservacionesInicio.this, ActivityPacienteObservacionMostrar.class);
            ...
            button_editar.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(ActivityCitaObservacionesInicio.this, ActivityPacienteObservacionEditar.class);
                    intent.putExtra("paciente_nombre", paciente_nombre);
                    intent.putExtra("paciente_nombre", paciente_nombre);
