...
public class ActivityPacientesEditar extends ActionBarActivity implements View.OnClickListener {
    private String nombre, apellido1, apellido2, cedula, nacimiento, fallecimiento, sexo, nacionalidad, direccion, telefono, email, telefono_anterior, email_anterior;
    private EditText editNombre, editApellido1, editApellido2, editCedula, editTelefono, editDireccion, editEmail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editDireccion  = (EditText) findViewById(R.id.edit_PacientesEditar_address);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.button_PacientesEditar_registrar:
                ...
                try {
                    dbPacientesEditar db = new dbPacientesEditar(this,progressBar,id,nombre,apellido1, apellido2,cedula,email,direccion,telefono,nacionalidad,sexo,nacimiento,fallecimiento);
                    db.execute();
